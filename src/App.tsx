        ...
        {phase === 'FEEDBACK' && logs.length > 0 && logs[0].nBackItem && (
          <div className="w-full h-full max-h-full flex flex-col animate-in zoom-in-95 overflow-hidden">
              <div className="bg-slate-900 border border-slate-700 rounded-3xl shadow-2xl flex flex-col h-full overflow-hidden">
                 ...
                 <div className="flex-1 overflow-y-auto grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-slate-800 min-h-0"><div className="p-4 flex flex-col items-center opacity-60 bg-slate-950/30"><div className="text-[10px] font-bold text-slate-500 uppercase mb-2 flex items-center gap-2 px-3 py-1 bg-slate-900 rounded-full border border-slate-800"><History className="w-3 h-3"/> N-{config.nBackLevel}</div><div className="mb-2 scale-[0.65] origin-center"><VisualRenderer stim={logs[0].nBackItem.stimulus} /></div><div className="mt-auto p-2 bg-slate-950 rounded-xl border border-slate-800 w-full text-center"><div className="text-[10px] text-slate-600 uppercase font-bold tracking-wider">Target Logic</div><div className="font-black text-lg text-slate-300">{logs[0].nBackItem.result}</div><div className="text-[10px] text-slate-600 mt-1 font-mono bg-black/50 p-1 rounded">{logs[0].nBackItem.stimulus.logicProof}</div></div></div><div className="p-4 flex flex-col items-center bg-slate-900/50"><div className="text-[10px] font-bold text-emerald-500 uppercase mb-2 flex items-center gap-2 px-3 py-1 bg-emerald-900/10 rounded-full border border-emerald-500/20"><Activity className="w-3 h-3"/> Current</div><div className="mb-2 scale-[0.75] origin-center"><VisualRenderer stim={logs[0].currentItem.stimulus} /></div><div className="mt-auto p-3 bg-black rounded-xl border border-slate-700 w-full text-center shadow-lg"><div className="text-[10px] text-slate-600 uppercase font-bold tracking-wider">Derived Logic</div><div className="font-black text-2xl text-white">{logs[0].currentItem.result}</div><div className="text-[10px] text-purple-400 mt-1 font-mono bg-slate-900 p-1 rounded border border-slate-800">{logs[0].currentItem.stimulus.logicProof}</div></div></div></div>
